...
const ITEMS: IItem[] = [
  {
    ...
    name: 'Броня',
    image: armorImage,
    effect: 'Защищает от одной кражи ключей или атаки',
    behavior: 'self',
    targetType: 'player',
    rarity: 0,
    range: -1,
  ...
  },
  {
    ...
    name: 'Неуязвимость',
    image: potionImage,
    effect: 'Защищает от кражи ключей или атак на 1 ход',
    behavior: 'self',
    targetType: 'player',
    rarity: 3,
    range: -1,
  ...
  },
  {
    ...
    name: 'Шокер',
    image: taserImage,
    effect: 'Крадет 3 ключа и парализует игрока на один ход',
    rarity: 0,
    behavior: 'single',
    targets: 1,
    targetType: 'player',
  ...
  },
  {
    ...
    name: 'Растяжка',
    image: trapImage,
    effect: 'Применяется на клетку. Крадет 5 ключей у следующего игрока, наступившего на клетку',
    rarity: 1,
    behavior: 'single',
    targets: 1,
    range: -1,
  ...
  },
  {
    ...
    effect: 'Применяется на клетку. Перемещает игрока на стартовую клетку и крадет 10 ключей у следующего игрока, наступившего на клетку',
    rarity: 2,
    behavior: 'single',
    targets: 1,
    range: -1,
  ...
  },
  {
    ...
    name: 'Ледяная Буря',
    image: iceStormImage,
    effect: 'Оглушает всех игроков на 1 ход и отнимает по 5 ключей',
    rarity: 3,
    range: -1,
    behavior: 'others',
    targetType: 'player',
